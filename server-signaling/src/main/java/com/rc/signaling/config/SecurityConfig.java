...
import com.rc.signaling.security.InternalServiceAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtService jwtService,
        ...
        http
                ...
                .addFilterBefore(new InternalServiceAuthFilter(securityProperties),
                        UsernamePasswordAuthenticationFilter.class)
                .addFilterAfter(new JwtAuthFilter(jwtService), InternalServiceAuthFilter.class);
